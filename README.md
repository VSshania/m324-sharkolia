...
Eine Web-Applikation mit einem einfachen Backend (Ohne DB), dass ein persönlichkeits Quiz anbietet und durch die Resultate dem User einen individualisierten Character zuweist.
